...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-primary-50 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 section-padding"
      ...
      <div className="container-custom text-center">
        <div className="max-w-3xl mx-auto">
          <div className="mb-6">
            <div className="inline-flex items-center justify-center rounded-full bg-white/90 p-4 shadow-soft dark:bg-slate-900/80">
              <img
                src={profileImage}
                alt="Numan Sayyad"
                className="w-40 h-40 rounded-full object-cover border-4 border-primary-600 shadow-xl"
              />
            </div>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-slate-950 dark:text-white mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <a
              href="#contact"
              className="bg-primary-600 text-white px-8 py-3 rounded-2xl font-semibold hover:bg-primary-700 transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl no-underline"
            >
              Get In Touch
            </a>
            ...
            <a
              href="/resume.pdf"
              download
              className="bg-white text-primary-600 border-2 border-primary-600 px-8 py-3 rounded-2xl font-semibold hover:bg-primary-50 transition-all duration-300 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl flex items-center gap-2 justify-center no-underline"
            >
